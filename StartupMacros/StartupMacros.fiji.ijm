...
//~~~ Début de l'outil Colon Analysis
//~~ Menu déroulant
var colonmenu = newMenu("Seagene Menu Tool", newArray("Foci and nuclei detection", "-", "Nuclei detection", "gamma-H2AX Foci detection", "-", "About"));

//~~ Macro pour lancer l'outil
macro "Seagene Menu Tool - "{
//macro "seagene Menu Tool - icon:detect_foci_tool.png"{
	camt_cmd = getArgument();
	if (camt_cmd == "About") {
		run("About ");
	} else if(camt_cmd == "Foci and nuclei detection"){
		run("Main Foci detection");
	} else if(camt_cmd == "Nuclei detection"){
		run("Nuclei detection");
	} else if(camt_cmd == "gamma-H2AX Foci detection"){
		run("Foci detection");
	} else{
		print("");
}	}
